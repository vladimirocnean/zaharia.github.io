...
// import 'classlist.js'/*tpa=http://programari.starecivila1.ro/classlist.js*/;  // Run `npm install --save classlist.js`.
...
Zone.__load_patch('ZoneAwarePromise', function (global, Zone, api) {
    ...
    var source = 'http://programari.starecivila1.ro/Promise.then';
    var UNRESOLVED = null;
    var RESOLVED = true;
    var REJECTED = false;
...
Zone.__load_patch('XHR', function (global, Zone, api) {
    ...
    function patchXHR(window) {
        ...
        var XMLHTTPREQUEST_SOURCE = 'http://programari.starecivila1.ro/XMLHttpRequest.send';
